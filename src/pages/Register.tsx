...
const Register = () => {
  ...
  return (
    <div style={{backgroundColor:"#001529", minHeight:"100vh", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:'center' ,}}>
      <h1 style={{color:"white", marginBottom:"20px"}}>Regster</h1>
      ...
      <div>
        <input placeholder="email"  style={{padding:"10px", width:'300px',borderRadius:"10px"}} type="text" id="id" {...register('email')} />
      </div>
      <div>
      ...
      <div>
        <input placeholder="phone"  style={{padding:"10px", width:'300px', borderRadius:"10px"}} type="text" id="id" {...register('phone')} />
      </div>
